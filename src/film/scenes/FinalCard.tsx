...
export function FinalCard({ t }: { t: number }) {
  ...
  return (
    <g>
      ...
      <g opacity={dateRuleP}>
        <rect x={540 - 400 * dateRuleP} y={1252} width={230 * dateRuleP} height={3} rx={1.5} fill="var(--brand-orange)" />
        <rect x={540 + 170} y={1252} width={230 * dateRuleP} height={3} rx={1.5} fill="var(--green)" />
      </g>
      <text
        x={540}
        y={1266}
